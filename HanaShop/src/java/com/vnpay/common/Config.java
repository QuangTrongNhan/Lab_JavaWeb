...
public class Config {
    ...
    public static String vnp_Returnurl = "http://localhost:8084/HanaShop/PayByVNPayServlet";
    public static String vnp_TmnCode = "TSRQSA46";
    public static String vnp_HashSecret = "EZVVNWUDCHAPQMFYLSMSVKHPSEFIIWUB";
