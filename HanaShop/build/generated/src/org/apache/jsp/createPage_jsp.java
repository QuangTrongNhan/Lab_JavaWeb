...
public final class createPage_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(HttpServletRequest request, HttpServletResponse response)
    ...
    try {
      ...
      out.write("            setInterval(1000, getDate());\n");
      out.write("            function getDate() {\n");
      out.write("                document.getElementById('date').innerHTML = date.getDate() + \":\" + date.getMonth() + 1 + \":\" + date.getFullYear();\n");
      out.write("            }\n");
      out.write("        </script>\n");
      out.write("    </body>\n");
      out.write("</html>\n");
  ...
  private boolean _jspx_meth_c_otherwise_0(javax.servlet.jsp.tagext.JspTag _jspx_th_c_choose_0, PageContext _jspx_page_context)
    ...
    if (_jspx_eval_c_otherwise_0 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
      do {
        out.write("\n");
        out.write("                <form action=\"ServletDispatcher\">\n");
        out.write("            ProductID: <input type=\"text\" required=\"\" name=\"txtProductID\" value=\"");
        ...
        out.write("\" /> <br>              \n");
        out.write("            \n");
        out.write("            ProductName: <input type=\"text\" required=\"\" name=\"txtProductName\" value=\"");
        ...
        out.write("\" /><br>\n");
        out.write("            Image: <input type=\"file\" name=\"txtFile\" required=\"\" value=\"");
        out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.evaluateExpression("${param.txtFile}", java.lang.String.class, (PageContext)_jspx_page_context, null));
        out.write("\" /><br>\n");
        out.write("            Description: <input type=\"text\" required=\"\" name=\"txtDescription\" value=\"");
        ...
        out.write("\" /><br>\n");
        out.write("            Price: <input type=\"number\" min=\"1\" required=\"\" name=\"Price\" value=\"");
        ...
        out.write("\" /><br>\n");
        out.write("            createDate:<p name=\"txtDate\" id=\"date\"></p><br> \n");
        out.write("            categoryID: <select name=\"categoryID\">\n");
        out.write("                <option >\n");
        out.write("                    f\n");
        out.write("                </option>\n");
        out.write("                <option>\n");
        ...
        out.write("                </option>\n");
        out.write("            </select><br>\n");
        out.write("            Quantity: <input type=\"number\" min=\"1\" required=\"\" name=\"txtQuantity\" value=\"");
        ...
        out.write("\" /><br>\n");
        out.write("            status: <select name=\"active\">\n");
        out.write("                <option>1</option>\n");
        out.write("            </select>\n");
        out.write("            <input type=\"submit\" value=\"Create\" name=\"btnAction\" />\n");
        out.write("            <a href=\"AdminPageServlet?pageIndex=1\">Back to admin page</a>\n");
        out.write("        </form>\n");
        out.write("\n");
        out.write("            ");
