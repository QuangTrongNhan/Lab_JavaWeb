...
<html lang="en">
    <head>
        ...
        <!-- Bootstrap core CSS -->
        <link href="/HanaShop/assets/bootstrap.min.css" rel="stylesheet"/>
        <!-- Custom styles for this template -->
        <link href="/HanaShop/assets/jumbotron-narrow.css" rel="stylesheet">      
        <script src="/HanaShop/assets/jquery-1.11.3.min.js"></script>
    </head>
