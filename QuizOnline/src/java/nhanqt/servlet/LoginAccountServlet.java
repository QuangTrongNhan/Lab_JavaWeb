...
public class LoginAccountServlet extends HttpServlet {
    private final String START_QUIZ = "startQuiz.jsp";
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            AccountDTO account = new AccountDAO().checkLogin(email, passwordSha);
            if(account != null){
                //check role
                if(account.getRole().equals("Student")){
                    url = START_QUIZ;
                    session.setAttribute("student", account);                   
                }//end if student login success
            }//end if login success
            else{
                request.setAttribute("error", "Username or password are incorrected!");
            }
